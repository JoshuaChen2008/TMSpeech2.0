...
[下载最新版本](https://github.com/JoshuaChen2008/TMSpeech2.0/releases) · [报告问题](https://github.com/JoshuaChen2008/TMSpeech2.0/issues) · [参与讨论](https://github.com/JoshuaChen2008/TMSpeech2.0/discussions)
...
1. 前往 [Releases](https://github.com/JoshuaChen2008/TMSpeech2.0/releases) 下载最新的 `TMSpeech.win-x64.zip`。
...
```powershell
git clone https://github.com/JoshuaChen2008/TMSpeech2.0.git
cd TMSpeech
...
- 在 [Issues](https://github.com/JoshuaChen2008/TMSpeech2.0/issues) 报告问题或提出功能建议。
- 在 [Discussions](https://github.com/JoshuaChen2008/TMSpeech2.0/discussions) 分享使用体验和模型推荐。
